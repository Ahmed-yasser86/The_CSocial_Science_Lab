...
def create_app(
    ...
    # The agent server (RetrievalPipeline/agent_server.py) is merged into this
    ...
    _RETRIVAL = str(_ROOT / "RetrievalPipeline")

    _GRAPH = str(_ROOT / "RetrievalPipeline" / "Graph")

    _GPT_RESEARCHER = str(_ROOT / "gpt-researcher")

    for _p in (_RETRIVAL, _GRAPH, _GPT_RESEARCHER):
