...
> The long-form narrative overview of the project: why it exists, the problem it investigates, the conceptual framework, the three systems, and the end-to-end pipeline. This is the narrative companion to the [README](https://github.com/Ahmed-yasser86/The_CSocial_Science_Lab#readme) (repo entry point) — same story, told for readers inside the docs site.
...
- **Social Layer** — User interaction through co-commenting patterns. Detail: [Methodology](for-researchers/methodology.md) (Social Network Construction)
- **Content/Semantic Layer** — Content relationships through transcript embeddings. Detail: [Content Homophily](pipelines/content-homophily.md)
- **Recommendation Layer** — Platform-mediated content connections. Detail: [Recommendation Crawling](pipelines/recommendation-crawling.md)
- **Community Layer** — Groups emerging from structural or semantic relationships. Detail: [Network Science](for-researchers/network.md)
- **Cross-Layer Relationships** — How these structures correspond or diverge. Detail: [Research Features](for-researchers/research-features.md)
...
Software structure: [Architecture](for-developers/architecture.md).
...
Per-pipeline detail (inputs, stages, algorithms, failures, code paths): [Pipelines](pipelines/index.md).
...
Full runbook: [Quickstart](for-developers/quickstart.md). Configuration: [Configuration](for-developers/configuration.md).
